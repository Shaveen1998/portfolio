...
export const experiences = [
  {
    ...
    desc: "Working on Smart Agro project where the motive was to designa nd develop and end to end Data visualisation Dashboard in real time which supports MQTT data.",
    skills: [
      "Node JS",
      "React JS",
      "AWS",
